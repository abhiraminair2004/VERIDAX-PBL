...
import { Users, Award, Calendar, MapPin, Search, Filter, ArrowRight } from "lucide-react"
        ...
        <div className="container px-4 md:px-6">
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  <Button asChild className="w-full mt-2">
                    <Link href={`/volunteer/opportunity/${index}`}>
                      View Details
          ...
          <div className="mt-8 text-center">
            <Button asChild variant="outline" size="lg" className="border-primary text-primary">
              <Link href="/volunteer/all">View All Opportunities</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                className="border-cream text-cream hover:bg-cream hover:text-primary-dark"
              >
                <Link href="/volunteer/organizations">For Organizations</Link>
              </Button>
            </div>
          </div>
        </div>
