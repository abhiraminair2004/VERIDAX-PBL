          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="/crowdfunding/start">Start a Campaign</Link>
                </Button>
              </div>
            </div>
        ...
        <div className="container px-4 md:px-6">
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  <Button asChild className="w-full mt-2 bg-secondary hover:bg-secondary-dark text-primary-dark">
                    <Link href={`/crowdfunding/campaign/${index}`}>
                      Donate Now
          ...
          <div className="mt-8 text-center">
            <Button asChild variant="outline" size="lg" className="border-secondary text-secondary">
              <Link href="/crowdfunding/all">View All Campaigns</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-secondary">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary-dark text-cream">
                <Link href="/crowdfunding/campaigns">Donate Now</Link>
              </Button>
              <Button
                asChild
                variant="outline"
